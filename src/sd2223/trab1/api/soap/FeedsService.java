...
public interface FeedsService {
	 ...
	 */
	@WebMethod
	long postMessage(String user, String pwd, Message msg) throws FeedsException, URISyntaxException;
	 ...
	 */
	@WebMethod
	Void removeFromPersonalFeed(String user, long mid, String pwd) throws FeedsException, URISyntaxException;
	 ...
	 */
	@WebMethod
	Message getMessage(String user, long mid) throws FeedsException, URISyntaxException;
	 ...
	 */
	@WebMethod
	List<Message> getMessages(String user, long time) throws FeedsException, URISyntaxException;

	/**
	 * Returns a list of all messages but only the ones that were posted by one specified user
	 * newer than time (note:may be a remote user)
	 * @param user user feed being accessed (format user@domain)
	 * @param time the oldest time of the messages to be returned
	 * @return a list of messages, potentially empty;
	 * @throws NOT_FOUND if the user does not exist.
	 */
	@WebMethod
	List<Message> getInternalMessages(String user,long time) throws FeedsException, URISyntaxException;
	/**
	 * Subscribe a user.
	 * A user must contact the server of her domain directly (i.e., this operation should not be
	 * propagated to other domain)
	 ...
	 */
	@WebMethod
	Void subUser(String user, String userSub, String pwd) throws FeedsException, URISyntaxException;
	 ...
	 */
	@WebMethod
	Void unsubscribeUser(String user, String userSub, String pwd) throws FeedsException, URISyntaxException;
	 ...
	 */
	@WebMethod
	List<String> listSubs(String user) throws FeedsException, URISyntaxException;
}
