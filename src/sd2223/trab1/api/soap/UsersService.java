...
public interface UsersService {
	...
	/**
	 * Checks in the server if there is any user with the given name.
	 * @param name of the user to find
	 * @throws UsersException otherwise
	 */
	@WebMethod
	Boolean hasUserNoPwd(String name) throws UsersException;

	/**
	 * Checks in the server if there is the user with the given name has the given password.
	 * @param name of the user to find
	 * @param pwd of the password to compare with
	 * @throws UsersException otherwise
	 */
	@WebMethod
