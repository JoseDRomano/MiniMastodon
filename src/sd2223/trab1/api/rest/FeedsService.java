...
public interface FeedsService {
    ...
    Long postMessage(@PathParam(USER) String user, @QueryParam(PWD) String pwd, Message msg) throws URISyntaxException;
    ...
    @DELETE
    @Path("/{" + USER + "}/{" + MID + "}")
    void removeFromPersonalFeed(@PathParam(USER) String user, @PathParam(MID) long mid, @QueryParam(PWD) String pwd) throws URISyntaxException;
    ...
    @Path("/{" + USER + "}/{" + MID + "}")
    @Produces(MediaType.APPLICATION_JSON)
    Message getMessage(@PathParam(USER) String user, @PathParam(MID) long mid) throws URISyntaxException;
    ...
    @Path("/{" + USER + "}")
    @Produces(MediaType.APPLICATION_JSON)
    List<Message> getMessages(@PathParam(USER) String user, @QueryParam(TIME) long time) throws URISyntaxException;


    @GET
    @Path("/{" + USER + "}/gim")
    @Produces(MediaType.APPLICATION_JSON)
    List<Message> getInternalMessages(@PathParam(USER) String user, @QueryParam(TIME) long time) throws URISyntaxException;
    ...
    void subUser(@PathParam(USER) String user, @PathParam(USERSUB) String userSub, @QueryParam(PWD) String pwd) throws URISyntaxException;
    ...
    @DELETE
    @Path("/sub/{" + USER + "}/{" + USERSUB + "}")
    void unsubscribeUser(@PathParam(USER) String user, @PathParam(USERSUB) String userSub, @QueryParam(PWD) String pwd) throws URISyntaxException;
    ...
    @Path("/sub/list/{" + USER + "}")
    @Produces(MediaType.APPLICATION_JSON)
    List<String> listSubs(@PathParam(USER) String user) throws URISyntaxException;
